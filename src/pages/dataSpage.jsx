	...
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		...
		<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
			...
			<div aria-hidden="true" className="mt-10 lg:mt-0">
				<img src="images7.jpg" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
			</div>
		</div>
		<div>
			<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
				...
				<div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
					<img src="images8.jpg" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
				</div>
			</div>
		</div>
	</div>
...
<section className="m-4 md:m-8 dark:bg-slate-950 dark:text-gray-100">
	...
	<div className="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
		<div className="flex flex-col items-center p-4">
			<svg   viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 dark:text-violet-400">
