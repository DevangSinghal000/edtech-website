...
export default function Contact() {
  ...
  <section className="relative z-10 overflow-hidden mt-0 bg-slate-950 py-20 lg:py-[120px]">
    <div className="container mx-auto">
      <div className="-mx-4 flex flex-wrap lg:justify-between">
        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div className="mb-12 max-w-[570px] lg:mb-0">
            <span className="text-rose-600 mb-4 block text-base font-semibold">
              Contact Us
            </span>
            <h2 className="text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
            ...
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                ...
                Near Mahindra SEZ, P.O. Mahapura, Ajmer Road, Jaipur, Rajasthan 302026
                </p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                ...
                <p className="text-white text-base">devangsinghal@jklu.edu.in</p>
              </div>
            </div>
          </div>
        </div>
        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div className="relative rounded-lg bg-gray-900 p-8 shadow-lg sm:p-12">
            <form>
              <div className="mb-6">
                <input
                  type="text"
                  placeholder="Your Name"
                  className="text-white border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                />
              </div>
              <div className="mb-6">
                <input
              ...
              <div className="mb-6">
                <textarea
                  ...
                  className="text-white border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  defaultValue={""}
                />
              </div>
              <div>
                <button
                  type="submit"
                  className="bg-primary border-primary hover:border-cyan-700 hover:text-cyan-500 w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                >
                  Send Message
                </button>
              </div>
